...
/*
  prop p : Forall x .
    r(x) ->
      (
        (Exists y . true S[<=3] p(y))
          &
        (Exists z . true S[<=4] q(z))
      )
*/
...
class Formula_p(monitor: Monitor) extends Formula(monitor) {
  ...
  val dPosArray = (15 to 17).toArray
  val cPosArray = (18 to 20).toArray
  val l1PosArray = (21 to 23).toArray
  val l2PosArray = (24 to 26).toArray
  ...
  val l1BDDList = generateBDDList(l1PosArray)
  val l2BDDList = generateBDDList(l2PosArray)

  val uBDDListHighToLow = uBDDList.reverse
  val l1BDDListHighToLow = l1BDDList.reverse
  val l2BDDListHighToLow = l2BDDList.reverse

  val tPosArrayHighToLow = tPosArray.reverse
  val dPosArrayHighToLow = dPosArray.reverse
  val l1PosArrayHighToLow = l1PosArray.reverse
  val l2PosArrayHighToLow = l2PosArray.reverse
  ...
  val var_l1_quantvar : BDD = bddGenerator.getQuantVars(l1PosArray)
  val var_l2_quantvar : BDD = bddGenerator.getQuantVars(l2PosArray)
  ...
  txt = Array(
    "Forall x . r(x) -> ((Exists y . true S[<=3] p(y)) & (Exists z . true S[<=4] q(z)))",
    "r(x) -> ((Exists y . true S[<=3] p(y)) & (Exists z . true S[<=4] q(z)))",
    "r(x)",
    "(Exists y . true S[<=3] p(y)) & (Exists z . true S[<=4] q(z))",
    "Exists y . true S[<=3] p(y)",
    "Exists t . true S[<=3] p(y)",
    "true S[<=3] p(y)",
    "true",
    "p(y)",
    "Exists z . true S[<=4] q(z)",
    "Exists t . true S[<=4] q(z)",
    "true S[<=4] q(z)",
    "true",
    "q(z)"
  )
